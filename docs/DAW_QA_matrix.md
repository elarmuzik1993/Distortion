# DAW QA Matrix — Distortion (Monolit Beatz)
...
(or **FL Studio**). macOS/Logic deferred with the macOS build (v2.3).

| Check | Reaper | Ableton | Bitwig | Notes |
|---|---|---|---|---|
| Scans / loads without error | ☐ | ☐ | ☐ | |
| Editor opens; no missing assets/fonts | ☐ | ☐ | ☐ | |
| Audio passes; all 7 clip types audible | ☐ | ☐ | ☐ | |
| Window scaling 70–100% renders clean | ☐ | ☐ | ☐ | X11 fold animation |
